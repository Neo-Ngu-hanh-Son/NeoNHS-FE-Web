            ...
            <DialogContent className="flex max-h-[92vh] max-w-5xl flex-col gap-0 overflow-hidden border border-slate-200 p-0 shadow-lg dark:border-slate-700">
                            ...
                            <div className="space-y-6 lg:col-span-7">
                                ...
                                {/* <Card className="rounded-2xl border border-slate-100 shadow-sm dark:border-slate-700">
                                    <CardHeader className="pb-3">
                                        ...
                                        <CardDescription>Âm thanh trong modal; panorama mở trang riêng</CardDescription>
                                    </CardHeader>
                                    <CardContent className="space-y-4">
                                        <div className="space-y-2">
                                            <Label className="text-sm font-medium">
                                                Âm thanh lịch sử ({editingPoint?.historyAudioCount ?? 0})
                                            </Label>
                                            <Button
                                                type="button"
                                                variant="outline"
                                            ...
                                            {!canUseAudioTab && (
                                                <p className="text-xs text-muted-foreground">Lưu điểm trước để cấu hình âm thanh lịch sử.</p>
                                            )}
                                        </div>
                                        <Separator />
                                        <div className="space-y-2">
                                            ...
                                            <Button
                                                ...
                                                onClick={() => {
                                                    if (!pointId) return;
                                                    navigate(`/admin/places/${pointId}/panorama/edit`);
                                                }}
                                            >
                                            ...
                                            {!canUseAudioTab && (
                                                <p className="text-xs text-muted-foreground">Lưu điểm trước để chỉnh panorama.</p>
                                            )}
                                        </div>
                ...
                {activeTab === 'point' ? (
                    ...
                    <DialogFooter className="shrink-0 border-t border-slate-100 px-6 py-4 dark:border-slate-700">
                        <Button type="button" variant="outline" onClick={() => onOpenChange(false)} className="w-full sm:ml-auto sm:w-auto">
                            Đóng
                        </Button>
                    </DialogFooter>
                )}
