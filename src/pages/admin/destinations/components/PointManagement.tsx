...
const POINT_TYPE_VI: Record<PointType, string> = {
    PAGODA: 'Chùa',
    CAVE: 'Hang động',
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                        <div className="flex min-w-0 items-start gap-3">
                            ...
                            <div className="min-w-0">
                                <CardTitle className="text-base font-semibold text-slate-900 dark:text-white">Danh sách điểm (POI)</CardTitle>
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="border-border hover:bg-transparent">
                                        ...
                                        <TableHead className="w-[120px] pr-4 text-center text-xs font-medium text-muted-foreground">Thao tác</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                    {loading ? (
                                            ...
                                            >
                                                ...
                                                <TableCell>
                                                    <div className="flex min-w-0 items-center gap-3">
                                                        ...
                                                        <span className="line-clamp-2 break-words font-medium text-slate-900 dark:text-slate-100" title={p.name}>
                                                            {p.name}
                                                        </span>
                                                    </div>
                                                </TableCell>
