      ...
      <Card className="shadow-sm border-none bg-emerald-50/10 h-full flex flex-col items-center justify-center py-20 text-center space-y-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground max-w-[200px]">
            Click the <span className="font-bold text-indigo-500">Points</span> button on a
            destination to manage its points of interest
          </p>
        </div>
      </Card>
    );
      ...
      <CardContent className="px-4 pb-4">
        <div className="bg-white p-4 rounded-xl border border-emerald-100 border-l-4 border-l-emerald-500 shadow-sm mb-4">
          ...
          <div className="flex justify-between items-center">
            <Badge
              variant="secondary"
              className="bg-emerald-100 text-emerald-700 text-[10px] uppercase font-bold tracking-wider border-none"
            >
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                size="sm"
                variant="outline"
                className="h-7 text-[11px] bg-emerald-50 border-emerald-200 text-emerald-700 hover:bg-emerald-100"
                onClick={onAddPoint}
              >
              ...
              {loading ? (
                ...
                currentDestination.points.map((p) => (
                  <TableRow key={p.id} className="hover:bg-emerald-50/50">
                    <TableCell className="text-center font-bold text-muted-foreground px-2">
                      {p.orderIndex}
                    </TableCell>
