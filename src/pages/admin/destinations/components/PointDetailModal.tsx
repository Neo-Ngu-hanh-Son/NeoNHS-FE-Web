...
export function PointDetailModal({ open, onOpenChange, point }: PointDetailModalProps) {
        ...
        <div className="flex flex-col gap-6 py-2">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-between items-start">
              ...
              <Badge
                variant="outline"
                className="bg-orange-50 text-orange-600 border-orange-200 uppercase text-[10px]"
              >
                {point.type}
              </Badge>
            </div>
