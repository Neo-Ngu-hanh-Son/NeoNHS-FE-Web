...
export function EventForm({ mode, initialData, onSubmit, loading }: EventFormProps) {
  ...
  const handleEditorSave = async (result: EditorSaveResult) => {
    ...
    if (result.charCount > 1000) {
      setErrors((prev) => ({
        ...prev,
        fullDescription: `Description is too long (${result.charCount}/1000 characters)`,
      }));
      return;
    }
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="e.g. Ngu Hanh Son District"
                maxLength={255}
              />
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Thumbnail {mode === 'create' && '*'}</CardTitle>
          </CardHeader>
