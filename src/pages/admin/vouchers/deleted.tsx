            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <CardTitle className="text-xl">Voucher đã xóa</CardTitle>
                            <CardDescription>Quản lý voucher đã tạm xóa — khôi phục hoặc xóa vĩnh viễn</CardDescription>
                        </div>
                    </div>
                </CardHeader>
                <CardContent>
                    {loading ? (
                        ...
                        <div className="text-center py-20 text-muted-foreground">
                            <p className="text-lg font-medium">Không có voucher đã xóa</p>
                            <p className="text-sm mt-1">Tất cả voucher đều đang hoạt động. Thùng rác trống.</p>
                        </div>
                    ) : (
