...
export function useEventTimelines(eventId: string, autoFetch: boolean = true): UseEventTimelinesReturn {
  ...
  const fetchTimelineById = useCallback(
    async (id: string): Promise<EventTimelineResponse | null> => {
  ...
  const createTimeline = useCallback(
    async (data: CreateEventTimelineRequest): Promise<boolean> => {
      try {
  ...
  const updateTimeline = useCallback(
    async (id: string, data: UpdateEventTimelineRequest): Promise<boolean> => {
      try {
